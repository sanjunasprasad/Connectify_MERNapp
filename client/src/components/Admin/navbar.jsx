    ...
    <nav className="bg-gray-800 p-4">
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center">
          <input type="text" placeholder="Search" className="border border-gray-700 px-3 py-1 mr-2 rounded-lg bg-gray-700 text-white" />
          <div className="relative">
            <button onClick={toggleDropdown} className="flex text-white focus:outline-none">
