...
import { getUserAccount,followUser,unfollowUser,suggetionList,reportProfile } from "../controllers/friendControllers.js"





friendRoute.get('/userAccount/:id',decodeToken,getUserAccount); //get frienduser profile
